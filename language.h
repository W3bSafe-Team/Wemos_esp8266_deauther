...
const char CLI_SERIAL_ENABLED[] PROGMEM = "已开启串口连接";
const char CLI_SERIAL_DISABLED[] PROGMEM = "已关闭串口连接";
const char CLI_ERROR[] PROGMEM = "ERROR: ";
const char CLI_ERROR_PARAMETER[] PROGMEM = "错误 无效参数 \"";
const char CLI_STOPPED_SCRIPT[] PROGMEM = "已停止脚本执行 \"";
const char CLI_CONTINUOUSLY[] PROGMEM = "连续";
const char CLI_EXECUTING[] PROGMEM = "执行 ";
const char CLI_SCRIPT_DONE_CONTINUE[] PROGMEM = "开始执行脚本 - 输入 'stop script' 命令终止脚本";
const char CLI_SCRIPT_DONE[] PROGMEM = "执行脚本完毕";
const char CLI_HELP_HEADER[] PROGMEM = "[===== 命令列表 =====]";
const char CLI_HELP_FOOTER[] PROGMEM =
    "========================================================================\r\n更多帮助请访问 github.com/W3bSafe-Team/Wemos_esp8266_deauther\r\n========================================================================";
...
const char CLI_RICE_ERROR[] PROGMEM = "错误 : 内存检查失败 位于 块 0x";
const char CLI_RICE_MEM[] PROGMEM = "检查内存块 0x";
const char CLI_CHICKEN_OUTPUT[] PROGMEM =
    "                                                                 ` - : /////////:-.                    \r\n                                                            ./++so:`   ``    `.:/++/.               \r\n                                                        `/+o+.+o:.s:-++//s`        `:++-            \r\n                                                     `/+oo+//d-   oh/    s-            :o/`         \r\n                                                   .++.o+` `h-   .d.     h`://+`         .o+        \r\n                                                 .o+` +/   +o    y-     +d+.  .y           .s-      \r\n                                                +o`   h    d`   `/     .h-    `h             ++     \r\n                                              .s-     d    -           .`     +/              /o    \r\n                                             :o`      y.                     -y                /+   \r\n                                            /+        :o       `            -h`                 s:  \r\n                                           /o          y..://///////:`     /o/o.                `h  \r\n                                          -s           +o:``       `-++::/+-  `o/                o: \r\n                                          y.          :o              `:::.`   `oo`              -s \r\n                                         -s           h`            .++:---/+/+/:::++.           `h \r\n                                         +/           h            :o`   `  `/s  `  .s-           d \r\n                                         o:          .s            h`   /h-   o:/h-  -s          `h \r\n                                         +/          +/            h`   ``    s- `   +/          -s \r\n                                         .y         `h`            -s-      `+y-.`.:+/           +: \r\n                                          o:        o:              `/+/:/+ss:.-:y/.`           `h` \r\n   .:-`                                   `y-      ++                  `so::-://+y.             +/  \r\n  :o.-/+:  :+//:`                          `s:   `+/                   -h//:::---:/o-          -y   \r\n  :o   `:o:h. `-+/`                         -d+.:o-                    .y.``...-/y/++`        `y.   \r\n   +/    `:hs    -o-                        o/:/yo:-`                   +y++s//+/.           `s.    \r\n    /o`    `oo`   `/+`                   .-:y/-`+:+so+/:-`              s-  y:              -s.     \r\n ++//+y:     -+     .o:            ``-:/+:-.`.:+/:hs+`++:/o/:.`        `h   .y`            /o`      \r\n`h` `./ys-            :o-   .--:////:-.`        `-/o/::.`/sh-:os/:.`   .y oo`+/          -o:        \r\n :o-   `-o+.           `/+o/:-..`                   `.:+++o/``/:-oo++/:.so+://`       `:+/`         \r\n  `/+:`   ..             `++`                           `.-/+/:-/sy.`+o:+y/-.      .-/+-`           \r\n    `-+/-                  .-                                `.:/o+:-:.```-:oy/:://:-`              \r\n       .:+/.                                                      `.-:/+/::s/-..`                   \r\n          .++.                                                          `.-h.                       \r\n            .o/                                                            +/                       \r\n              :o.                                                          :o                       \r\n               .o:                                                         -s                       \r\n                 /o`                                                       :+                       \r\n                  -o-                                                      o:                       \r\n                   `o/                                                     h`                       \r\n                     :o.                                                  -s                        \r\n                      .o:                                                 y.                        \r\n                        /o.                                              /+                         \r\n                         .+/`                                           -s                          \r\n                           -+/.                                        .s`                          \r\n                             ./+/.`                                   -s`                           \r\n                                .:/+:.`                              /o`                            \r\n                                    .:/o/.`                        .o:                              \r\n                                       o/:/+/.`                  .++`                               \r\n                                       -s   `:/+:`            `:+/`                                 \r\n                                        ++`     -+o-`      `-++-                                    \r\n                                         :s/::/+//::+/---/+/:`                                      \r\n                                          +/s:`      `-h-s-                                         \r\n                                          +/s-        `y y.                                         \r\n                                          +/y.        `y h`                                         \r\n                                          //s:`       `y d                                          \r\n                                          +/-:/++/-`  `y h-`                                        \r\n                                          y:hs-ysosss..y --/+++/-`                                  \r\n                                          ds:`s:o+`-:`o:oos./h++osoo`                               \r\n                                          ::   o+++   h:y `o+.s:`.::                                \r\n                                                -+-   -/`   :s.++                                   \r\n                                                             `/+-   ";
const char CLI_SYSTEM_INFO[] PROGMEM = "[======== 系统信息 ========]";
const char CLI_SYSTEM_OUTPUT[] PROGMEM = "运行内存: %u 字节 已使用 [%d%%], %u 字节 空闲 [%d%%], %u 字节 总内存\r\n";
const char CLI_SYSTEM_AP_MAC[] PROGMEM = "AP MAC 地址: ";
const char CLI_SYSTEM_ST_MAC[] PROGMEM = "基站 MAC address: ";
const char CLI_SYSTEM_RAM_OUT[] PROGMEM = "SPIFFS: %u 字节 已使用 [%d%%], %u 字节 空闲 [%d%%], %u 字节 in 总内存\r\n";
const char CLI_SYSTEM_SPIFFS_OUT[] PROGMEM = "        块大小 %u 字节, 页面文件 %u 字节\r\n";
const char CLI_FILES[] PROGMEM = "文件: ";
const char CLI_BYTES[] PROGMEM = " 字节";
const char CLI_SYSTEM_FOOTER[] PROGMEM = "===============================";
const char CLI_FORMATTING_SPIFFS[] PROGMEM = "欢迎使用Wemos Esp8266开发板\r\n由W3bsafe-Team二次开发\r\n格式化 SPIFFS 分区中...";
const char CLI_REMOVED[] PROGMEM = "移除 ";
const char CLI_ERROR_REMOVING[] PROGMEM = "错误:已移除 ";
const char CLI_REMOVING_LINES[] PROGMEM = "行已被删除 ";
const char CLI_COPIED_FILES[] PROGMEM = "文件已复制";
const char CLI_ERROR_COPYING[] PROGMEM = "错误：文件复制中";
const char CLI_RENAMED_FILE[] PROGMEM = "已重命名文件";
const char CLI_ERROR_RENAMING_FILE[] PROGMEM = "错误：文件重命名中";
const char CLI_WRITTEN[] PROGMEM = "已写入 \"";
const char CLI_TO[] PROGMEM = "\" to ";
const char CLI_REPLACED_LINE[] PROGMEM = "已替换行";
...
const char CLI_DEAUTHING[] PROGMEM = "已启动取消验证洪水攻击 ";
const char CLI_ARROW[] PROGMEM = " -> ";
const char CLI_SENDING_BEACON[] PROGMEM = "发射广播 \"";
const char CLI_SENDING_PROBE[] PROGMEM = "Sending Probe \"";
const char CLI_CUSTOM_SENT[] PROGMEM = "发送自定义数据包";
const char CLI_CUSTOM_FAILED[] PROGMEM = "发送自定义数据包失败";
const char CLI_DRAW_OUTPUT[] PROGMEM = "%+4u";
const char CLI_ERROR_NOT_FOUND_A[] PROGMEM = "错误: 命令行 \"";
const char CLI_ERROR_NOT_FOUND_B[] PROGMEM = "\" 未找到 :(";
const char CLI_SYSTEM_CHANNEL[] PROGMEM = "当前Wi-Fi信道: ";
const char CLI_CHANGED_SCREEN[] PROGMEM = "改变屏幕模式";
